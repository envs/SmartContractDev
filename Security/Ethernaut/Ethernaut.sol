...
/**
    @title Ownable.
    @dev The Ownable contract has an owner address, and provides basic authentication control
...
contract Ownable {
    ...
    */
    modifier onlyOwner() {
        require(isOwner(), "Only owner can implement action");
    }
    ...
    */
    ...
    /**
        @dev Allows the current owner to give up control of the contract.
        It will not be possible to call the functions again with the `onlyOwner` modifier anymore.
        @notice Renouncing ownership will leave the contract without an owner, thereby removing any 
    ...
    */
    ...
    /**
        @dev Allows the current owner to transfer control of the new contract to a newOwner.
    ...
    */
    ...
    /**
        @dev Transfers control of the contract to newOwner
        @param newOwner The address to transfer ownership to.
    */
    function _transferOwnership(address newOwner) internal {
        require(newOwner != address(0), "Already the owner");
